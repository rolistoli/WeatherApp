...
|---|---|---|
| <img src="docs/screenshots/home-dark.jpg" width="220" alt="Home screen in dark mode"> | <img src="docs/screenshots/search-dark.jpg" width="220" alt="Search screen in dark mode"> | <img src="docs/screenshots/map-location-dark.jpg" width="220" alt="Map location popup in dark mode"> |

| Results | Settings |
|---|---|
| <img src="docs/screenshots/results-dark.jpg" width="220" alt="Results screen in dark mode"> | <img src="docs/screenshots/settings-dark.jpg" width="220" alt="Settings screen in dark mode"> |

### Light Mode

| Home | Search | Map Location |
|---|---|---|
| <img src="docs/screenshots/home-light.jpg" width="220" alt="Home screen in light mode"> | <img src="docs/screenshots/search-light.jpg" width="220" alt="Search screen in light mode"> | <img src="docs/screenshots/map-location-light.jpg" width="220" alt="Map location popup in light mode"> |

| Results | Settings |
|---|---|
| <img src="docs/screenshots/results-light.jpg" width="220" alt="Results screen in light mode"> | <img src="docs/screenshots/settings-light.jpg" width="220" alt="Settings screen in light mode"> |
